...
def parse_args():
    ...
    parser.add_argument('--n-sent', type=int, default=100,
...
def gen_text(model, dataset, args):
    ...
    while cnt < args.n_sent: 
        ...
        word_id = torch.multinomial(prob, num_samples=1).item() # pick char based on probability instead of always picking the highest value
