...
def parse_args():
    ...
    parser.add_argument('--lr', type=float, default=2.9607797708165323e-06, help='learning rate (default: 0.0001)')
    parser.add_argument('--dropout', type=float, default=0.2, help='dropout rate (default: 0.2)')
    parser.add_argument('--epochs', type=int, default=100, help='number of epochs to train (default: 30)')
    parser.add_argument('--log-interval', type=int, default=100, help='number of batches to wait before logging status (default: 100)')
...
def train(model, optimizer, args, data):  #data=corpus.get_data()=ids (batchsize, seq_length)
    ...
    plt.savefig('C:\\Python\Pytorch\\Transformer related\\Project Haruki Murakami\\loss picture\\training_loss.png')
